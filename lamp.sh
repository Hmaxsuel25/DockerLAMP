...
cat << EOB
    ...
    **********************************************
    *                                            *
    *    Imagem Docker: anbiros/lamp             *
    *    https://github.com/hmaxsuel25/DockerLAMP*
    *                                            *
    **********************************************
    Configuração do servidor LAMP
    ---------------
    · Redirecionamento de log do apache para  STDOUT [LOG_STDOUT]: No.
    · Redirecionamento de erros do apache no STDERR [LOG_STDERR]: $LOG_STDERR
    · Nivel do log [LOG_LEVEL]: $LOG_LEVEL
